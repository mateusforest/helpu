...
export function autonomySummary(state,esc) {
  ...
  const scheduling=!p.enabled?'Ative a rotina para agendar gerações pela conversa.':!state.worker?.running?'Você pode programar pedidos avulsos ou semanais pela conversa. Falta confirmar a execução recente do serviço.':'Peça pela conversa uma data e horário ou dias recorrentes. O horário inicia a geração; a prévia chega quando o processamento termina.';
  const video=state.creationCapabilities?.reels?'Crie Reels de 15 ou 30 segundos, em 9:16 ou 16:9, com seus materiais. Receba o MP4 na Biblioteca e na conversa para aprovar ou pedir ajustes.':state.runtime?.available&&state.runtime?.video?'O Astra Vídeo online pode criar cenas com texto, cortar MP4 e exportar. Abra Biblioteca → Astra Vídeo ou peça na conversa.':state.creationCapabilities?.reelsReason||(!connected?'Conecte o Astra para criar vídeos com seus materiais.':'O editor online está preparado. Falta ativar o serviço de vídeo na hospedagem.');
  return '<section class="panel autonomy-summary"><h2>O que o Astra pode fazer sozinho</h2><dl><div><dt>Criar pelo chat</dt><dd>Em Conversar e executar, seu pedido autoriza criar textos, imagens e exportar vídeos. Você não precisa aprovar a geração novamente. Limites, materiais exigidos e proibições continuam valendo.</dd></div><div><dt>Criar sem abrir uma conversa</dt><dd>'+esc(routine)+'</dd></div><div><dt>Agendar gerações</dt><dd>'+esc(scheduling)+'</dd></div><div><dt>Publicar</dt><dd>Você publica manualmente. A Helpu prepara o material e a legenda.</dd></div><div><dt>Receber no WhatsApp</dt><dd>Vincule seu WhatsApp na conversa para receber respostas e arquivos. O envio depende da janela de atendimento; o material permanece disponível na Biblioteca.</dd></div><div><dt>Editar vídeos</dt><dd>'+esc(video)+'</dd></div></dl></section>';
}
