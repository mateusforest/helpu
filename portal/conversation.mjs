...
import {VIDEO_PRESETS,VIDEO_TRANSITIONS,VIDEO_FITS} from './video-styles.mjs';
...
TOOLS.push(tool('creation_review','Aprova uma prévia, solicita ajuste versionado ou salva o estilo de uma imagem ou vídeo aprovado. Aprovar e salvar estilo somente quando o cliente pedir. Use creation_library para resolver o ID; nunca adivinhe. Não publica. Ajustes geram nova versão; no plano há uma rodada incluída. Aprovar libera o arquivo final e contabiliza a entrega.',{id:string,action:{type:'string',enum:['approve','revise','save-style']},adjustment:string,name:string,videoOptions:videoSettings},['id','action']));
