...
test('every help topic includes steps, example, expected outcome and recovery with real routes',()=>{
  const routes=new Set(['studio','conversation','brand','company','create/reels','create/feed','settings','integrations','activity','assisted','admin','consultations','consultations-admin']);
