...
test('todas as áreas e formulários produzem HTML sem erros de execução',()=>{
 ...
 const routes=vm.runInContext('routes.map(x=>x[0])',ctx);assert.equal(routes.length,28);
